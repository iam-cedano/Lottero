...
let ChannelStatisticRepository = class ChannelStatisticRepository extends base_repository_1.default {
    constructor(pool) {
    ...
    async findByChannelAndDate(channelId, date) {
        const result = await this.pool.query(`SELECT * FROM ${this.tableName} WHERE channel_id = $1 AND the_date = $2`, [channelId, date]);
        return result.rows[0] ?? null;
    }
};
ChannelStatisticRepository = __decorate([
    (0, tsyringe_1.injectable)(),
    __param(0, (0, tsyringe_1.inject)("PgPool")),
    __metadata("design:paramtypes", [pg_1.Pool])
], ChannelStatisticRepository);
exports.default = ChannelStatisticRepository;
